...
class EicOnPublicationRepositoryTests {
    @Autowired
    private lateinit var eicOnPublicationRepository: EicOnPublicationRepository
    @Autowired
    private lateinit var jdbcTemplate: JdbcTemplate

    @Test
    fun `assert is eic on publication`() {
    ...
    @Test
    fun `retrieve eic emails by publication id`() {
