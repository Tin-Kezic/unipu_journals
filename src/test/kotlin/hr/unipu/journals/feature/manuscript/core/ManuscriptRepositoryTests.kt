...
class ManuscriptRepositoryTests {
    @Autowired
    private lateinit var manuscriptRepository: ManuscriptRepository
    @Autowired
    private lateinit var jdbcTemplate: JdbcTemplate

    @Test
    fun `increment views by manuscript id`() {
    ...
    @Test
    fun `increment downloads by manuscript id`() {
    ...
    @Test
    fun `retrieve manuscripts pending review for account by account id where parent section and publication isn't hidden`() {
        assertEquals(
            listOf(
                ...
                Manuscript(
                    ...
                    "Analyzes genomic sequences using deep neural networks to predict mutations.",
                    11,
                    1,
                    ManuscriptState.AWAITING_EDITOR_REVIEW,
                    7,
                    "http://example.com/ms2.pdf",
                    LocalDateTime.of(2023, 9, 28, 13, 28, 0),
                    null,
                    245,
                    33
                ),
                Manuscript(
                    ...
                    "Extracting insights from unstructured clinical data using NLP.",
                    10,
                    2,
                    ManuscriptState.AWAITING_REVIEWER_REVIEW,
                    11,
                    "http://example.com/ms3.pdf",
                    LocalDateTime.of(2022, 9, 28, 13, 28, 0),
                    null,
                    310,
                    47
                ),
                Manuscript(
                    11,
                    "Machine Learning for Radiology2",
                    "A study on using ML to detect anomalies in radiological images.2",
                    10,
                    1,
                    ManuscriptState.AWAITING_EIC_REVIEW,
                    2,
                    "http://example.com/ms21.pdf",
                    LocalDateTime.of(2016, 9, 28, 13, 28, 0),
                    null,
                    135,
                    26
                )
    ...
    fun `retrieve all manuscripts contained in certain section by section id`() {
        assertEquals(
            listOf(
                Manuscript(
                    21,
                    "Manuscript awaiting deletion",
                    "description of manuscript awaiting deletion",
                    11,
                    5,
                ...
                Manuscript(
                    20,
                    "Wearable Technology and AI Integration2",
                ...
                Manuscript(
                    19,
                    "Clinical Trial Optimization with AI2",
                    "Optimizing patient recruitment and trial design using machine learning.2",
                    10,
                    5,
                    ManuscriptState.HIDDEN,
                    2,
                    "http://example.com/ms29.pdf",
                    LocalDateTime.of(2008, 9, 28, 13, 28, 0),
                    LocalDateTime.of(2025, 7, 25, 17, 45, 0),
                    61,
                    8
                ),
                Manuscript(
                    18,
                    "AI-Based Mental Health Assessment2",
                    "Assessing mental health using sentiment analysis and behavioral data.2",
                    11,
                    4,
                    ManuscriptState.ARCHIVED,
                    2,
                    "http://example.com/ms28.pdf",
                    LocalDateTime.of(2009, 9, 28, 13, 28, 0),
                    LocalDateTime.of(2025, 6, 30, 13, 30, 0),
                    22,
                    4
                ),
                Manuscript(
                    17,
                    "Predictive Analytics in Emergency Care2",
                    "Forecasting patient outcomes in emergency rooms using AI.2",
                    10,
                    4,
                    ManuscriptState.REJECTED,
                    2,
                    "http://example.com/ms27.pdf",
                    LocalDateTime.of(2010, 9, 28, 13, 28, 0),
                    null,
                    46,
                    6
                ),
                Manuscript(
                    16,
                    "AI in Medical Decision Making2",
                    "Examining the implications of autonomous decision systems in healthcare.2",
                    11,
                    3,
                    ManuscriptState.PUBLISHED,
                    2,
                    "http://example.com/ms26.pdf",
                    LocalDateTime.of(2011, 9, 28, 13, 28, 0),
                    LocalDateTime.of(2025, 6, 30, 13, 32, 16),
                    513,
                    89
                ),
                Manuscript(
                    15,
                    "Reinforcement Learning in Surgery2",
                    "Simulating surgical procedures using reinforcement learning algorithms.2",
                    10,
                    3,
                    ManuscriptState.MAJOR,
                    2,
                    "http://example.com/ms25.pdf",
                    LocalDateTime.of(2012, 9, 28, 13, 28, 0),
                    null,
                    88,
                    13
                ),
                Manuscript(
                    14,
                    "AI-Powered Drug Discovery2",
                    "Accelerating pharmaceutical research through predictive modeling.2",
                    11,
                    2,
                    ManuscriptState.MINOR,
                    2,
                    "http://example.com/ms24.pdf",
                    LocalDateTime.of(2013, 9, 28, 13, 28, 0),
                    null,
                    99,
                    20
                ),
                Manuscript(
                    13,
                    "Natural Language Processing in Clinical Notes2",
                    "Extracting insights from unstructured clinical data using NLP.2",
                    10,
                    2,
                    ManuscriptState.AWAITING_REVIEWER_REVIEW,
                    2,
                    "http://example.com/ms23.pdf",
                    LocalDateTime.of(2014, 9, 28, 13, 28, 0),
                    null,
                    311,
                    48
                ),
                Manuscript(
                    12,
                    "Deep Learning in Genomics2",
                    "Analyzes genomic sequences using deep neural networks to predict mutations.2",
                    11,
                    1,
                    ManuscriptState.AWAITING_EDITOR_REVIEW,
                    2,
                    "http://example.com/ms22.pdf",
                    LocalDateTime.of(2015, 9, 28, 13, 28, 0),
                    null,
                    246,
                    34
                ),
        ...
        assertEquals(
            listOf(
                ...
                Manuscript(
                    ...
                    "Optimizing patient recruitment and trial design using machine learning.",
                    10,
                    5,
                    ManuscriptState.HIDDEN,
                    1,
                    "http://example.com/ms9.pdf",
                    LocalDateTime.of(2018, 9, 28, 13, 28, 0),
                    LocalDateTime.of(2025, 7, 25, 17, 45, 0),
                    60,
                    7
                ),
                Manuscript(
                    ...
                    "Forecasting patient outcomes in emergency rooms using AI.",
                    10,
                    4,
                    ManuscriptState.REJECTED,
                    1,
                    "http://example.com/ms7.pdf",
                    LocalDateTime.of(2025, 9, 28, 13, 28, 0),
                    null,
                    45,
                    5
                ),
                Manuscript(
                    ...
                    "Simulating surgical procedures using reinforcement learning algorithms.",
                    10,
                    3,
                    ManuscriptState.MAJOR,
                    1,
                    "http://example.com/ms5.pdf",
                    LocalDateTime.of(2021, 9, 28, 13, 28, 0),
                    null,
                    87,
                    12
                ),
                ...
                Manuscript(
                    ...
                    "A study on using ML to detect anomalies in radiological images.",
                    10,
                    1,
                    ManuscriptState.AWAITING_EIC_REVIEW,
                    1,
                    "http://example.com/ms1.pdf",
                    LocalDateTime.of(2025, 9, 28, 13, 28, 0),
                    null,
                    134,
                    25
