...
class AccountRoleOnManuscriptRepositoryTests {
    ...
    @Test
    fun `retrieve authors by manuscript id`() {
        assertEquals(
    ...
    @Test
    fun `retrieve corresponding author by manuscript id`() {
    ...
    @Test
    fun `assert is role on manuscript`() {
        ...
        Assertions.assertFalse(
            accountRoleOnManuscriptRepository.isRoleOnManuscript(
                ManuscriptRole.CORRESPONDING_AUTHOR,
                11,
                1
            )
        )
