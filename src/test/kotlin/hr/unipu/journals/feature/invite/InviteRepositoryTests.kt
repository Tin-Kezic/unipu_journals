...
class InviteRepositoryTests {
    ...
    @Test
    fun `retrieve eic on publication emails by publication id`() {
        assertEquals(
    ...
    @Test
    fun `retrieve section editors on section emails by section id`() {
        assertEquals(
    ...
    @Test
    fun `retrieve all publications under review with affiliation by email`() {
        assertEquals(
            listOf(
    ...
    @Test
    fun `retrieve all manuscripts with affiliation by email`() {
        assertEquals(
            listOf(
                Manuscript(
                    2,
    ...
    @Test
    fun `invite section editor on section`() {
    ...
    @Test
    fun `invite editor on manuscript`() {
    ...
    @Test
    fun `invite reviewer on manuscript`() {
    ...
    @Test
    fun `revoke eic on publication invite`() {
    ...
    @Test
    fun `revoke section editor on section invite`() {
    ...
    @Test
    fun `revoke eic on manuscript invite`() {
    ...
    @Test
    fun `revoke editor on manuscript invite`() {
    ...
    @Test
    fun `revoke reviewer on manuscript invite`() {
