...
const val AUTHORIZATION_SERVICE_IS_SECTION_EDITOR_ON_SECTION = "@authorizationService.isEicOnPublication(#publicationId) || @authorizationService.isSectionEditorOnSection(#sectionId)"
const val AUTHORIZATION_SERVICE_IS_EDITOR_ON_MANUSCRIPT = "@authorizationService.isEicOnPublication(#publicationId) || @authorizationService.isSectionEditorOnSection(#sectionId) || @authorizationService.isEditorOnManuscript(#manuscriptId)"
